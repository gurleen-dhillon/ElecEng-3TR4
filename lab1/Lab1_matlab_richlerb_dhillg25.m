%% triangular wave generator but making it into a square wave generator
clc
clear all
hold off
...
f0=1000;     %fundamental freq of input triangular wave
T0 = 1/f0;  %period 
tstep = 0.005*T0;
...
gp1 =  A*sign(sin(2*pi*f0*tt1)); %input
...
%Hf = 1 ./(1+1i*f/fc) ; % 1st order filter transfer function
Hf = 1 ./(((1i*f/fc).^2)+(1.414*1i*f/fc)+1); % 2nd order filter transfer function
